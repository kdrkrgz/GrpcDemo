...
namespace GrpcServer.Protos {
    ...
    static CustomersReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "IAEoCRIPCgdpc0FsaXZlGAQgASgJEgsKA2FnZRgFIAEoBTJDCghDdXN0b21l",
  ...
  public sealed partial class CustomerModel : pb::IMessage<CustomerModel> {
    ...
    private string isAlive_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public string IsAlive {
      get { return isAlive_; }
      set {
        isAlive_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public override int GetHashCode() {
      ...
      if (IsAlive.Length != 0) hash ^= IsAlive.GetHashCode();
    ...
    public int CalculateSize() {
      ...
      if (IsAlive.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(IsAlive);
      }
      if (Age != 0) {
